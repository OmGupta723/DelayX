...
with open(os.path.join(model_dir, 'knn_scaler.pkl'), 'wb') as f:
...
with open(os.path.join(model_dir, 'knn_flight_delay_model.pkl'), 'wb') as f:
    pickle.dump(model, f)
    accuracy_data = {"model": "KNN", "accuracy": round(accuracy * 100, 2)}
with open(os.path.join(model_dir, 'knn_accuracy.json'), 'w') as f:
